...
(function () {
  ...
  style.textContent = `
    #refitWhatsappWidget {
      ...
      box-shadow: 0 10px 24px rgba(37,211,102,.28), 0 8px 20px rgba(0,0,0,.25) !important;
    ...
    #refitWhatsappWidget::before {
      ...
      animation: refitWaPulse 2.4s infinite !important;
  ...
  link.innerHTML = `
    ...
    <div class="refit-wa-text">WhatsApp</div>
  `;
